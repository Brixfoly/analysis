...
(* the Measure Extension theorem from `measure_theory`.                       *)
(*                                                                            *)
(* References:                                                                *)
...
(*                                 instance: idfun                            *)
(*      cumulativeBounded R l r == type of cumulative functions f such that   *)
(*                                 f @ -oo --> l and f @ +oo --> r            *)
(*                                 The HB class is CumulativeBounded.         *)
(* ```                                                                        *)
(*                                                                            *)
(* The modules RGenOInfty, RGenInftyO, RGenCInfty, RGenOpens, ROpenSets       *)
(* provide proofs of equivalence between the sigma-algebra generated by       *)
(* open-closed intervals and the sigma-algebras generated by open rays,       *)
(* closed rays, open intervals, and open sets.                                *)
(*                                                                            *)
(* We distinguish in particular the sigma-algebras generated by ocitv and     *)
(* and open sets for which we introduce the following definitions/notations:  *)
(* ```                                                                        *)
...
(*                  open_type R == alias for R : realType                     *)
(*                      R.-open := sigma_display (@open R)                    *)
(*          R.-open.-measurable == sigma-algebra generated by open sets       *)
(* ```                                                                        *)
(* The modules `MeasurableRocitv` and `MeasurableRopen` contains resp. the    *)
(* sigma-algebras generated from ocitv and open sets. They contain similar    *)
(* definitions:                                                               *)
(* ```                                                                        *)
(*            measurableTypeR R == measurableType generated by                *)
(*                                 R.-ocitv or R.-open                        *)
(*          @lebesgue_display R == (measure_)display for the sigma-algebra    *)
(*                                 generated by R.-ocitv or R.-open           *)
(*               @measurableR R == measurable sets generated by               *)
(*                                 R.-ocitv or R.-open                        *)
(* ```                                                                        *)
(* The module `MeasurableR` contains the default sigma-algebra, which is      *)
(* `MeasurableRopen`. The latter contains in addition:                        *)
(* ```                                                                        *)
(*             ocitv_measure mu == measure over the sigma-algebra             *)
(*                                 generated by open sets built out of mu,    *)
(*                                 the same measure over the sigma-algebra    *)
(*                                 generated by ocitv                         *)
(* ```                                                                        *)
(* The last part of the file contains the construction of the Lebesgue-       *)
(* Stieltjes measure:                                                         *)
(* ```                                                                        *)
...
Let measure_semi_sigma_additive : semi_sigma_additive ocitv_measure.
Proof.
move=> F H1 H2 H3; apply: measure_semi_sigma_additive => //.
- move=> i; apply: H1; split => //=; first exact: sigma_algebra_measurable.
  by rewrite -RGenOpenSets.measurableE; exact: sub_sigma_algebra.
- by rewrite -RGenOpenSets.measurableE.
Qed.

HB.instance Definition _ := isMeasure.Build _ _ _ ocitv_measure
...
Proof.
have := measure_extension_sigma_finite (wlength_sigma_finite f).
